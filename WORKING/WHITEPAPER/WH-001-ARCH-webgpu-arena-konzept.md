# Whitepaper: WebGPU-Arena Konzept

## Was ist die WebGPU-Arena?
Die WebGPU-Arena ist eine Plattform, auf der du verschiedene Künstliche Intelligenzen (LLMs für Text & T2I für Bilder) direkt miteinander nutzen und vergleichen kannst. Das Besondere: Alles passiert **rein lokal** auf deinem eigenen Gerät.
...
2. **Modelle aus der Community**: Wir nutzen Open-Source-Modelle von Hugging Face, die speziell für Web-Umgebungen optimiert sind.
3. **Einfacher Vergleich & Generierung**: Du kannst Texte vergleichen (Arena) oder hochwertige Bilder generieren – alles im selben Interface.
...
- **Direkt als App installierbar**: Die WebGPU-Arena funktioniert als "Progressive Web App" (PWA). Du kannst sie mit einem Klick auf deinem Startbildschirm speichern und wie eine echte App nutzen – ganz ohne App-Store-Zwang.
...
Um sicherzustellen, dass die WebGPU-Arena stabil bleibt und mathematische Berechnungen (wie das ELO-Ranking) präzise sind, nutzen wir automatisierte Unit-Tests.
